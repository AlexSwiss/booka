...
func (ec *executionContext) unmarshalNNewAuthor2githubᚗcomᚋAlexSwissᚋbookwormᚋgraphᚋmodelᚐNewAuthor(ctx context.Context, v interface{}) (model.NewAuthor, error) {
	return ec.unmarshalInputNewAuthor(ctx, v)
}

func (ec *executionContext) unmarshalNNewAuthor2ᚕᚖgithubᚗcomᚋAlexSwissᚋbookwormᚋgraphᚋmodelᚐNewAuthorᚄ(ctx context.Context, v interface{}) ([]*model.NewAuthor, error) {
	...
	for i := range vSlice {
		res[i], err = ec.unmarshalNNewAuthor2ᚖgithubᚗcomᚋAlexSwissᚋbookwormᚋgraphᚋmodelᚐNewAuthor(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNNewAuthor2ᚖgithubᚗcomᚋAlexSwissᚋbookwormᚋgraphᚋmodelᚐNewAuthor(ctx context.Context, v interface{}) (*model.NewAuthor, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalNNewAuthor2githubᚗcomᚋAlexSwissᚋbookwormᚋgraphᚋmodelᚐNewAuthor(ctx, v)
	return &res, err
}
